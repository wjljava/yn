...
<head>
	...
	<link href="${basePath}/resources/yn-admin/plugins/bootstrap-3.3.0/css/bootstrap.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/yn-admin/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/yn-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/yn-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/yn-admin/css/admin.css" rel="stylesheet"/>
	<style>
		/** skins **/
	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/resources/yn-admin/images/logo.png"/>
			</a>
	...
	<section id="content">
		...
		<div class="content_main">
			<div id="iframe_home" class="iframe cur">
				...
				<p><b>演示地址</b>：<a href="http://www.yinuocredit.cn/ynAdmin" target="_blank">http://www.yinuocredit.cn/ynAdmin</a></p>
...
<script src="${basePath}/resources/yn-admin/plugins/jquery.1.12.4.min.js"></script>
<script src="${basePath}/resources/yn-admin/plugins/bootstrap-3.3.0/js/bootstrap.min.js"></script>
<script src="${basePath}/resources/yn-admin/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${basePath}/resources/yn-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/yn-admin/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/yn-admin/plugins/device.min.js"></script>
<script src="${basePath}/resources/yn-admin/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/yn-admin/js/admin.js"></script>
<script src="${basePath}/resources/yn-admin/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/yn-admin/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>