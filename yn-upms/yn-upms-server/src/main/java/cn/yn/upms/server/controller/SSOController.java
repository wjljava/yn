package cn.yn.upms.server.controller;

import cn.yn.common.base.BaseController;
import cn.yn.common.util.RedisUtil;
import cn.yn.upms.client.shiro.session.UpmsSession;
import cn.yn.upms.client.shiro.session.UpmsSessionDao;
import cn.yn.upms.common.constant.UpmsResult;
import cn.yn.upms.common.constant.UpmsResultConstant;
import cn.yn.upms.dao.model.UpmsSystemExample;
import cn.yn.upms.rpc.api.UpmsSystemService;
import cn.yn.upms.rpc.api.UpmsUserService;
...
/**
 * 单点登录管理
 * Created by wangjianlong on 2016/12/10.
 */
@Controller
@RequestMapping("/sso")
