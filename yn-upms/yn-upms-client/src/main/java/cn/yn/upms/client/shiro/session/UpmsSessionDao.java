package cn.yn.upms.client.shiro.session;

import cn.yn.common.util.RedisUtil;
import cn.yn.upms.client.util.SerializableUtil;
...
public class UpmsSessionDao extends CachingSessionDAO {
    ...
    // 会话key
    private final static String ZHENG_UPMS_SHIRO_SESSION_ID = "yn-upms-shiro-session-id";
    // 全局会话key
    private final static String ZHENG_UPMS_SERVER_SESSION_ID = "yn-upms-server-session-id";
    // 全局会话列表key
    private final static String ZHENG_UPMS_SERVER_SESSION_IDS = "yn-upms-server-session-ids";
    // code key
    private final static String ZHENG_UPMS_SERVER_CODE = "yn-upms-server-code";
    // 局部会话key
