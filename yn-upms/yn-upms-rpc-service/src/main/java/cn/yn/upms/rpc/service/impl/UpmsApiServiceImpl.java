...
import cn.yn.upms.dao.mapper.*;
import cn.yn.upms.dao.model.*;
import cn.yn.upms.rpc.api.UpmsApiService;
import cn.yn.upms.rpc.mapper.UpmsApiMapper;
...
/**
 * UpmsApiService实现
 * Created by wangjianlong on 2016/01/19.
 */
@Service
@Transactional
public class UpmsApiServiceImpl implements UpmsApiService {
     ...
     */
    @Override
    @Cacheable(value = "yn-upms-rpc-service-ehcache", key = "'selectUpmsPermissionByUpmsUserId_' + #upmsUserId")
     ...
     */
    @Override
    @Cacheable(value = "yn-upms-rpc-service-ehcache", key = "'selectUpmsRoleByUpmsUserId_' + #upmsUserId")
