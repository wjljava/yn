...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/wangjianlong/yn/pulls)
[![GitHub stars](https://img.shields.io/github/stars/wangjianlong/yn.svg?style=social&label=Stars)](https://github.com/wangjianlong/yn)
[![GitHub forks](https://img.shields.io/github/forks/wangjianlong/yn.svg?style=social&label=Fork)](https://github.com/wangjianlong/yn)

交流QQ群：133107819🈵、284280411🈵、305155242🈵、528049386、157869467(群内含各种工具、文档、视频教程下载)

## 前言

　　`yn`项目创建于2016年10月4日，正在慢慢成长中，目的不仅仅是一个开发架构，而是努力打造一套从 **前端模板** - **基础框架** - **分布式架构** - **开源项目** - **持续集成** - **自动化部署** - **系统监测** - **无缝升级** 的全方位J2EE企业级开发解决方案。
...
├── yn-common -- SSM框架公共模块
├── yn-admin -- 后台管理模板
├── yn-ui -- 前台thymeleaf模板[端口:1000]
├── yn-config -- 配置中心[端口:1001]
├── yn-upms -- 用户权限管理系统
|    ├── yn-upms-common -- upms系统公共模块
|    ├── yn-upms-dao -- 代码生成模块，无需开发
|    ├── yn-upms-client -- 集成upms依赖包，提供单点认证、授权、统一会话管理
|    ├── yn-upms-rpc-api -- rpc接口包
|    ├── yn-upms-rpc-service -- rpc服务提供者
|    └── yn-upms-server -- 用户权限系统及SSO服务端[端口:1111]
├── yn-cms -- 内容管理系统
|    ├── yn-cms-common -- cms系统公共模块
|    ├── yn-cms-dao -- 代码生成模块，无需开发
|    ├── yn-cms-rpc-api -- rpc接口包
|    ├── yn-cms-rpc-service -- rpc服务提供者
|    ├── yn-cms-search -- 搜索服务[端口:2221]
|    ├── yn-cms-admin -- 后台管理[端口:2222]
|    ├── yn-cms-job -- 消息队列、任务调度等[端口:2223]
|    └── yn-cms-web -- 网站前台[端口:2224]
├── yn-pay -- 支付系统
|    ├── yn-pay-common -- pay系统公共模块
|    ├── yn-pay-dao -- 代码生成模块，无需开发
|    ├── yn-pay-rpc-api -- rpc接口包
|    ├── yn-pay-rpc-service -- rpc服务提供者
|    ├── yn-pay-sdk -- 开发工具包
|    ├── yn-pay-admin -- 后台管理[端口:3331]
|    └── yn-pay-web -- 演示示例[端口:3332]
├── yn-ucenter -- 用户系统(包括第三方登录)
|    ├── yn-ucenter-common -- ucenter系统公共模块
|    ├── yn-ucenter-dao -- 代码生成模块，无需开发
|    ├── yn-ucenter-rpc-api -- rpc接口包
|    ├── yn-ucenter-rpc-service -- rpc服务提供者
|    └── yn-ucenter-web -- 网站前台[端口:4441]
├── yn-wechat -- 微信系统
|    ├── yn-wechat-mp -- 微信公众号管理系统
|    |    ├── yn-wechat-mp-dao -- 代码生成模块，无需开发
|    |    ├── yn-wechat-mp-service -- 业务逻辑
|    |    └── yn-wechat-mp-admin -- 后台管理[端口:5551]
|    └── yn-ucenter-app -- 微信小程序后台
├── yn-api -- API接口总线系统
|    ├── yn-api-common -- api系统公共模块
|    ├── yn-api-rpc-api -- rpc接口包
|    ├── yn-api-rpc-service -- rpc服务提供者
|    └── yn-api-server -- api系统服务端[端口:6666]
├── yn-oss -- 对象存储系统
|    ├── yn-oss-sdk -- 开发工具包
|    ├── yn-oss-web -- 前台接口[端口:7771]
|    └── yn-oss-admin -- 后台管理[端口:7772]
├── yn-shop -- 电子商务系统
├── yn-im -- 即时通讯系统
├── yn-oa -- 办公自动化系统
├── yn-eoms -- 运维系统
└── yn-demo -- 示例模块(包含一些示例代码等)
     ├── yn-demo-rpc-api -- rpc接口包
     ├── yn-demo-rpc-service -- rpc服务提供者
     └── yn-demo-web -- 演示示例[端口:8888]
```
...
ynAdmin | 后台管理系统模板  | [https://github.com/wangjianlong/ynAdmin](https://github.com/wangjianlong/ynAdmin)
autoMail | 邮箱地址自动补全插件  | [https://github.com/wangjianlong/autoMail](https://github.com/wangjianlong/autoMail)
yn.jprogress.js | 加载进度条插件  | [https://github.com/wangjianlong/yn.jprogress.js](https://github.com/wangjianlong/yn.jprogress.js)
yn.jtotop.js | 返回顶部插件  | [https://github.com/wangjianlong/yn.jtotop.js](https://github.com/wangjianlong/yn.jtotop.js)
...
基于bootstrap实现的响应式Material Design风格的通用后台管理系统，`yn`项目所有后台系统都是使用该模块界面作为前端展示。
...
![API网关](project-bootstrap/yn-api.png)
...
![统一扫码支付](project-bootstrap/yn-pay.png)
...
[环境搭建和系统部署文档(作者：小兵)](http://git.oschina.net/wangjianlong/yn/attach_files "环境搭建和系统部署文档(作者：小兵)")
...
- dubbo-admin-2.5.3 [http://download.csdn.net/detail/wangjianlong5201314/9733652](http://download.csdn.net/detail/wangjianlong5201314/9733652 "dubbo-admin-2.5.3")
- dubbo-admin-2.5.4-SNAPSHOT-jdk8 [http://download.csdn.net/detail/wangjianlong5201314/9733657](http://download.csdn.net/detail/wangjianlong5201314/9733657 "dubbo-admin-2.5.4-SNAPSHOT-jdk8")
- 更多资源请加QQ群
...
- 127.0.0.1	ui.yinuocredit.cn
- 127.0.0.1	upms.yinuocredit.cn
- 127.0.0.1	cms.yinuocredit.cn
- 127.0.0.1	pay.yinuocredit.cn
- 127.0.0.1	ucenter.yinuocredit.cn
- 127.0.0.1	wechat.yinuocredit.cn
- 127.0.0.1	api.yinuocredit.cn
- 127.0.0.1	oss.yinuocredit.cn
...
maven编译安装yn/pom.xml文件即可

### 启动顺序（后台）

> 准备工作

- 新建yn数据库，导入project-datamodel文件夹下的yn.sql

- 修改各dao模块和rpc-service模块的redis.properties、jdbc.properties、generator.properties数据库连接等配置信息，其中master.redis.password、master.jdbc.password、slave.jdbc.password、generator.jdbc.password密码值使用了AES加密，请使用cn.yn.common.util.AESUtil工具类修改这些值

- 启动Zookeeper、Redis、ActiveMQ、Nginx（配置文件参考project-tools/nginx下的*.conf文件）

> **yn-upms**

- 首先启动 yn-upms-rpc-service(直接运行src目录下的YnUpmsRpcServiceApplication#main方法启动) => yn-upms-server(jetty)，然后按需启动对应子系统xxx的yn-xxx-rpc-service(main方法) => yn-xxx-webapp(jetty)

![启动演示](project-bootstrap/start.png)

- 访问 [http://upms.yinuocredit.cn:1111/](http://upms.yinuocredit.cn:1111/ "统一后台地址")，子系统菜单已经配置到yn-upms权限中，不用直接访问子系统，默认帐号密码：admin/123456

- 登录成功后，可在右上角切换已注册系统访问

> **yn-cms**

- yn-cms-admin：启动ActiveMQ-启动 => 启动yn-rpc-service => 启动yn-cms-admin

- yn-cms-web：启动nginx代理yn-ui静态资源，配置文件可参考 [nginx.conf](http://git.oschina.net/wangjianlong/yn/attach_files)

> **yn-oss**

- 首先启动yn-oss-web服务

- 开发阶段，如果yn-oss-web没有公网域名，推荐使用`ngrok`内网穿透工具，为开发环境提供公网域名，实现上传回调

- 启动nginx代理yn-ui静态资源


### 开发演示（QQ群内有“yn十分钟视频：从检出到启动.wmv”）
...
### 部署方式（QQ群内有“yn十分钟视频：从打包到linux服务器部署.wmv”）

- war包项目：使用tomcat等web容器启动

- rpc-service服务提供者jar包：将打包后的yn-xxx-rpc-service-assembly.tar.gz文件解压，使用bin目录的管理脚本运行即可，支持优雅停机。
...
- 模块命名为`项目`-`子项目`-`业务`，如`yn-cms-admin`

- 数据表命名为：`子系统`_`表`，如`cms_article`

- 更多规范，参考[[阿里巴巴Java开发手册] http://git.oschina.net/wangjianlong/yn/attach_files

```

## 演示地址

演示地址： [http://upms.yinuocredit.cn/](http://47.93.195.63/yn-upms-server/sso/login?backurl=http%3A%2F%2F47.93.195.63%2Fyn-upms-server%2Fmanage%2Findex "演示地址")

### 预览图
![idea](project-bootstrap/idea.png)
![login](project-bootstrap/yn-login.png)
![upms](project-bootstrap/yn-upms.png)
![cms](project-bootstrap/yn-cms.png)
![swagger](project-bootstrap/api.png)

### 数据模型
![数据库模型](project-datamodel/yn.png)
...
首先谢谢大家支持，如果你希望参与开发，欢迎通过[Github](https://github.com/wangjianlong/yn "Github")上fork本项目，并Pull Request您的commit。
...
- 报yn-xxx.jar包找不到,请按照文档编译顺序，将源代码编译并安装到本地maven仓库

- yn-cms-admin启动卡住：因为没有启动activemq

- yn-upms-server访问报session不存在：因为没有启动redis服务

- 界面没有样式：因为yn-admin没有编译安装到本地仓库

## 附件

### 优秀文章和博客

- [创业互联网公司如何搭建自己的技术框架](http://wangjianlong5201314.iteye.com/blog/2330151 "创业互联网公司如何搭建自己的技术框架")

- [微服务实战](https://segmentfault.com/a/1190000004634172 "微服务实战")

- [单点登录原理与简单实现](http://wangjianlong5201314.iteye.com/blog/2343910 "单点登录原理与简单实现")
...
- [支付系统架构](http://wangjianlong5201314.iteye.com/blog/2355431 "支付系统架构")
...
- [做个男人，做个成熟的男人，做个有城府的男人](http://wangjianlong5201314.iteye.com/blog/1387820 "做个男人，做个成熟的男人，做个有城府的男人")
